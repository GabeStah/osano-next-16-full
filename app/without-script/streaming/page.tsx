...
// Simulate fetching different sections with varying delays
async function fetchHeroData() {
  await new Promise((resolve) => setTimeout(resolve, 200));
  return {
    title: "Welcome to Streaming SSR",
    subtitle: "Watch the page progressively render as data loads",
  };
}
...
async function fetchRecentActivity() {
  ...
  return [
    ...
    { id: 4, user: "Diana", action: "Added team member", time: "1 hour ago" },
  ];
}
  ...
  return (
    ...
    >
      {stats.map((stat) => (
        ...
        >
          <p style={{ margin: 0, fontSize: "1.5rem", fontWeight: 600, color: "#00d9ff" }}>
            {stat.value}
          </p>
        ...
        >
          <div
            style={{
              ...
              height: 8,
              borderRadius: "50%",
              background: priorityColors[rec.priority as keyof typeof priorityColors],
            }}
          />
  ...
  return (
    <div>
      ...
      <p style={{ color: "rgba(255, 255, 255, 0.7)", marginBottom: "2rem" }}>
        Next.js streams HTML from the server as components become ready. 
        Refresh the page to see progressive loading in action!
      </p>
      ...
      <div className="card">
        ...
        <pre>{`// Server Components stream automatically with Suspense
  ...
  return (
    <>
      ...
      <div className="card">
        <h3 className="card-title">
          <span>🧪</span>
          Live Demo - Dashboard Streaming
        </h3>
        <p className="card-description">
          This simulated dashboard has 4 sections with different load times. 
          Watch them appear progressively!
        </p>
