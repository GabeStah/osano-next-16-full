...
<form action={addMessage}>
  ...
  <button type="submit">Send</button>
      ...
      <div className="card">
        <h3 className="card-title">
          <span>🧪</span>
          Live Demo - Message Board
        </h3>
        <p className="card-description">
          Add and delete messages using Server Actions. The page automatically 
          revalidates to show the latest data.
        </p>
      ...
      <div className="card">
        ...
        <div className="demo-box">
          <p style={{ margin: 0, fontSize: "0.85rem", color: "rgba(255,255,255,0.6)" }}>
            This page is a <strong>Server Component</strong>. Data was fetched at:{" "}
